                ...
                if not result.fetchone():
                    ...
                    await session.execute(text("""
                        INSERT INTO user_settings (
                            id, user_id, show_transaction_details, show_reference_number, 
                            show_payment_method, show_location, default_currency, 
                            date_format, number_format, created_at, updated_at
                        ) VALUES (
                            gen_random_uuid(), :user_id, TRUE, TRUE, TRUE, TRUE, 'CHF', 
                            'DD/MM/YYYY', 'Swiss', NOW(), NOW()
                        )
                    """), {"user_id": user_id})
