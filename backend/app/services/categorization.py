...
class CategorizationService:
    ...
    def categorize_transaction_and_learn(self, transaction_id: str, category_id: str, vendor_name: Optional[str] = None) -> Dict:
        ...
        return {
            ...
            "vendor_created": vendor.name,
            "similar_transactions_categorized": categorized_count,
            "pattern_learned": normalized_vendor,
        ...
        for vendor in vendors:
            ...
            if best_similarity > 0.4:  # Lower threshold for suggestions
                suggestions.append({
                    ...
                    "category_id": str(vendor.default_category_id),
