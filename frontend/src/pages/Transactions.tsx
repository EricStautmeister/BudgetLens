...
export default function Transactions() {
    ...
    // FIXED: Changed 'event' to '_event' to mark it as an intentionally unused parameter,
    // which is required by Material-UI's TablePagination onPageChange signature.
